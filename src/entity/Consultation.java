...
public class Consultation {
    ...
    // Constructor
    public Consultation(int consultationId, int patientId, int doctorId, LocalDate consultationDate, LocalTime consultationTime, String consultationStatus, String consultationType) {
